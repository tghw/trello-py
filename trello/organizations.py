...
class Organizations(object):
    ...
    def get_board(self, idOrg_or_name, filter=None, fields=None, actions=None, actions_entities=None, actions_limit=None, actions_format=None, actions_since=None, action_fields=None, memberships=None, organization=None, organization_fields=None, lists=None):
        resp = requests.get("https://trello.com/1/organizations/%s/boards" % (idOrg_or_name), params={"key": self._apikey, "token": self._token, "filter": filter, "fields": fields, "actions": actions, "actions_entities": actions_entities, "actions_limit": actions_limit, "actions_format": actions_format, "actions_since": actions_since, "action_fields": action_fields, "memberships": memberships, "organization": organization, "organization_fields": organization_fields, "lists": lists}, data=None)
        resp.raise_for_status()
        return json.loads(resp.content)

    def get_board_filter(self, filter, idOrg_or_name):
        resp = requests.get("https://trello.com/1/organizations/%s/boards/%s" % (idOrg_or_name, filter), params={"key": self._apikey, "token": self._token}, data=None)
        resp.raise_for_status()
        return json.loads(resp.content)

    def get_delta(self, idOrg_or_name, tags, ixLastUpdate):
        resp = requests.get("https://trello.com/1/organizations/%s/deltas" % (idOrg_or_name), params={"key": self._apikey, "token": self._token, "tags": tags, "ixLastUpdate": ixLastUpdate}, data=None)
        resp.raise_for_status()
        return json.loads(resp.content)

    def get_member(self, idOrg_or_name, filter=None, fields=None, activity=None):
        resp = requests.get("https://trello.com/1/organizations/%s/members" % (idOrg_or_name), params={"key": self._apikey, "token": self._token, "filter": filter, "fields": fields, "activity": activity}, data=None)
        resp.raise_for_status()
        return json.loads(resp.content)

    def get_member_filter(self, filter, idOrg_or_name):
        resp = requests.get("https://trello.com/1/organizations/%s/members/%s" % (idOrg_or_name, filter), params={"key": self._apikey, "token": self._token}, data=None)
        resp.raise_for_status()
        return json.loads(resp.content)
    ...
    def get_member_card_idMember(self, idMember, idOrg_or_name, actions=None, attachments=None, attachment_fields=None, members=None, member_fields=None, checkItemStates=None, checklists=None, board=None, board_fields=None, list=None, list_fields=None, filter=None, fields=None):
        resp = requests.get("https://trello.com/1/organizations/%s/members/%s/cards" % (idOrg_or_name, idMember), params={"key": self._apikey, "token": self._token, "actions": actions, "attachments": attachments, "attachment_fields": attachment_fields, "members": members, "member_fields": member_fields, "checkItemStates": checkItemStates, "checklists": checklists, "board": board, "board_fields": board_fields, "list": list, "list_fields": list_fields, "filter": filter, "fields": fields}, data=None)
        resp.raise_for_status()
        return json.loads(resp.content)

    def get_membersInvited(self, idOrg_or_name, fields=None):
        resp = requests.get("https://trello.com/1/organizations/%s/membersInvited" % (idOrg_or_name), params={"key": self._apikey, "token": self._token, "fields": fields}, data=None)
        resp.raise_for_status()
        return json.loads(resp.content)

    def get_membersInvited_field(self, field, idOrg_or_name):
        resp = requests.get("https://trello.com/1/organizations/%s/membersInvited/%s" % (idOrg_or_name, field), params={"key": self._apikey, "token": self._token}, data=None)
        resp.raise_for_status()
        return json.loads(resp.content)

    def get_membership(self, idOrg_or_name, filter=None, member=None):
        resp = requests.get("https://trello.com/1/organizations/%s/memberships" % (idOrg_or_name), params={"key": self._apikey, "token": self._token, "filter": filter, "member": member}, data=None)
        resp.raise_for_status()
        return json.loads(resp.content)

    def get_membership_idMembership(self, idMembership, idOrg_or_name, member=None):
        resp = requests.get("https://trello.com/1/organizations/%s/memberships/%s" % (idOrg_or_name, idMembership), params={"key": self._apikey, "token": self._token, "member": member}, data=None)
        resp.raise_for_status()
        return json.loads(resp.content)

    def get_pluginData(self, idOrg_or_name):
        resp = requests.get("https://trello.com/1/organizations/%s/pluginData" % (idOrg_or_name), params={"key": self._apikey, "token": self._token}, data=None)
        resp.raise_for_status()
        return json.loads(resp.content)
    ...
    def update(self, idOrg_or_name, prefs_orgInviteRestrict=None, prefs_externalMembersDisabled=None, prefs_associatedDomain=None, prefs_googleAppsVersion=None, prefs_boardVisibilityRestrict_private=None, prefs_boardVisibilityRestrict_org=None, prefs_boardVisibilityRestrict_public=None, name=None, displayName=None, desc=None, website=None, prefs_permissionLevel=None):
        resp = requests.put("https://trello.com/1/organizations/%s" % (idOrg_or_name), params={"key": self._apikey, "token": self._token}, data={"prefs/orgInviteRestrict": prefs_orgInviteRestrict, "prefs/externalMembersDisabled": prefs_externalMembersDisabled, "prefs/associatedDomain": prefs_associatedDomain, "prefs/googleAppsVersion": prefs_googleAppsVersion, "prefs/boardVisibilityRestrict/private": prefs_boardVisibilityRestrict_private, "prefs/boardVisibilityRestrict/org": prefs_boardVisibilityRestrict_org, "prefs/boardVisibilityRestrict/public": prefs_boardVisibilityRestrict_public, "name": name, "displayName": displayName, "desc": desc, "website": website, "prefs/permissionLevel": prefs_permissionLevel})
        resp.raise_for_status()
        return json.loads(resp.content)

    def update_desc(self, idOrg_or_name, value):
        resp = requests.put("https://trello.com/1/organizations/%s/desc" % (idOrg_or_name), params={"key": self._apikey, "token": self._token}, data={"value": value})
        resp.raise_for_status()
        return json.loads(resp.content)

    def update_displayName(self, idOrg_or_name, value):
        resp = requests.put("https://trello.com/1/organizations/%s/displayName" % (idOrg_or_name), params={"key": self._apikey, "token": self._token}, data={"value": value})
        resp.raise_for_status()
        return json.loads(resp.content)

    def update_member(self, idOrg_or_name, email, fullName, type=None):
        resp = requests.put("https://trello.com/1/organizations/%s/members" % (idOrg_or_name), params={"key": self._apikey, "token": self._token}, data={"email": email, "fullName": fullName, "type": type})
        resp.raise_for_status()
        return json.loads(resp.content)

    def update_member_idMember(self, idMember, idOrg_or_name, type):
        resp = requests.put("https://trello.com/1/organizations/%s/members/%s" % (idOrg_or_name, idMember), params={"key": self._apikey, "token": self._token}, data={"type": type})
        resp.raise_for_status()
        return json.loads(resp.content)

    def update_member_deactivated_idMember(self, idMember, idOrg_or_name, value):
        resp = requests.put("https://trello.com/1/organizations/%s/members/%s/deactivated" % (idOrg_or_name, idMember), params={"key": self._apikey, "token": self._token}, data={"value": value})
        resp.raise_for_status()
        return json.loads(resp.content)

    def update_membership_idMembership(self, idMembership, idOrg_or_name, type, member_fields=None):
        resp = requests.put("https://trello.com/1/organizations/%s/memberships/%s" % (idOrg_or_name, idMembership), params={"key": self._apikey, "token": self._token}, data={"type": type, "member_fields": member_fields})
        resp.raise_for_status()
        return json.loads(resp.content)

    def update_name(self, idOrg_or_name, value):
        resp = requests.put("https://trello.com/1/organizations/%s/name" % (idOrg_or_name), params={"key": self._apikey, "token": self._token}, data={"value": value})
        resp.raise_for_status()
        return json.loads(resp.content)

    def update_pref_associatedDomain(self, idOrg_or_name, value):
        resp = requests.put("https://trello.com/1/organizations/%s/prefs/associatedDomain" % (idOrg_or_name), params={"key": self._apikey, "token": self._token}, data={"value": value})
        resp.raise_for_status()
        return json.loads(resp.content)

    def update_pref_boardVisibilityRestrict_org(self, idOrg_or_name, value):
        resp = requests.put("https://trello.com/1/organizations/%s/prefs/boardVisibilityRestrict/org" % (idOrg_or_name), params={"key": self._apikey, "token": self._token}, data={"value": value})
        resp.raise_for_status()
        return json.loads(resp.content)

    def update_pref_boardVisibilityRestrict_private(self, idOrg_or_name, value):
        resp = requests.put("https://trello.com/1/organizations/%s/prefs/boardVisibilityRestrict/private" % (idOrg_or_name), params={"key": self._apikey, "token": self._token}, data={"value": value})
        resp.raise_for_status()
        return json.loads(resp.content)

    def update_pref_boardVisibilityRestrict_public(self, idOrg_or_name, value):
        resp = requests.put("https://trello.com/1/organizations/%s/prefs/boardVisibilityRestrict/public" % (idOrg_or_name), params={"key": self._apikey, "token": self._token}, data={"value": value})
        resp.raise_for_status()
        return json.loads(resp.content)

    def update_pref_externalMembersDisabled(self, idOrg_or_name, value):
        resp = requests.put("https://trello.com/1/organizations/%s/prefs/externalMembersDisabled" % (idOrg_or_name), params={"key": self._apikey, "token": self._token}, data={"value": value})
        resp.raise_for_status()
        return json.loads(resp.content)

    def update_pref_googleAppsVersion(self, idOrg_or_name, value):
        resp = requests.put("https://trello.com/1/organizations/%s/prefs/googleAppsVersion" % (idOrg_or_name), params={"key": self._apikey, "token": self._token}, data={"value": value})
        resp.raise_for_status()
        return json.loads(resp.content)

    def update_pref_orgInviteRestrict(self, idOrg_or_name, value):
        resp = requests.put("https://trello.com/1/organizations/%s/prefs/orgInviteRestrict" % (idOrg_or_name), params={"key": self._apikey, "token": self._token}, data={"value": value})
        resp.raise_for_status()
        return json.loads(resp.content)

    def update_pref_permissionLevel(self, idOrg_or_name, value):
        resp = requests.put("https://trello.com/1/organizations/%s/prefs/permissionLevel" % (idOrg_or_name), params={"key": self._apikey, "token": self._token}, data={"value": value})
        resp.raise_for_status()
        return json.loads(resp.content)

    def update_website(self, idOrg_or_name, value):
        resp = requests.put("https://trello.com/1/organizations/%s/website" % (idOrg_or_name), params={"key": self._apikey, "token": self._token}, data={"value": value})
        resp.raise_for_status()
        return json.loads(resp.content)
    ...
    def new_logo(self, idOrg_or_name, file):
        resp = requests.post("https://trello.com/1/organizations/%s/logo" % (idOrg_or_name), params={"key": self._apikey, "token": self._token}, data={"file": file})
        resp.raise_for_status()
        return json.loads(resp.content)

    def delete(self, idOrg_or_name):
        resp = requests.delete("https://trello.com/1/organizations/%s" % (idOrg_or_name), params={"key": self._apikey, "token": self._token}, data=None)
        resp.raise_for_status()
        return json.loads(resp.content)

    def delete_logo(self, idOrg_or_name):
        resp = requests.delete("https://trello.com/1/organizations/%s/logo" % (idOrg_or_name), params={"key": self._apikey, "token": self._token}, data=None)
        resp.raise_for_status()
        return json.loads(resp.content)

    def delete_member_idMember(self, idMember, idOrg_or_name):
        resp = requests.delete("https://trello.com/1/organizations/%s/members/%s" % (idOrg_or_name, idMember), params={"key": self._apikey, "token": self._token}, data=None)
        resp.raise_for_status()
        return json.loads(resp.content)

    def delete_member_all_idMember(self, idMember, idOrg_or_name):
        resp = requests.delete("https://trello.com/1/organizations/%s/members/%s/all" % (idOrg_or_name, idMember), params={"key": self._apikey, "token": self._token}, data=None)
        resp.raise_for_status()
        return json.loads(resp.content)

    def delete_pref_associatedDomain(self, idOrg_or_name):
        resp = requests.delete("https://trello.com/1/organizations/%s/prefs/associatedDomain" % (idOrg_or_name), params={"key": self._apikey, "token": self._token}, data=None)
        resp.raise_for_status()
        return json.loads(resp.content)

    def delete_pref_orgInviteRestrict(self, idOrg_or_name, value):
        resp = requests.delete("https://trello.com/1/organizations/%s/prefs/orgInviteRestrict" % (idOrg_or_name), params={"key": self._apikey, "token": self._token, "value": value}, data=None)
        resp.raise_for_status()
        return json.loads(resp.content)
